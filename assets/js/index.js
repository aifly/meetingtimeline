...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "F:\\xuchang2018\\project\\meetingtimeline\\components\\list\\index.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
		...
		methods: {
			...
			beginAnimate: function beginAnimate() {
				var _this = this;
		...
		mounted: function mounted() {
			...
			var render = function render() {
				...
				if (!_this2.isStoped && _this2.imgList[_this2.index] && !_this2.showTeam) {
					...
					if (_this2.imgList[_this2.index].scale >= 1.4 && !_this2.imgList[_this2.index].stoped) {
						_this2.imgList[_this2.index].stoped = true;
						_this2.isStoped = true;
						setTimeout(function () {
							_this2.isStoped = false;
						}, 2000);
					}

					if (_this2.imgList[_this2.index].scale >= 1.5) {
						_this2.imgList[_this2.index].scale = 1.5;

						///this.imgList[this.index].opacity -=.005;

						_this2.imgList[_this2.index].transZ += 15;
						if (_this2.imgList[_this2.index].transZ > 1000) {
							_this2.imgList[_this2.index].scale = 0;
							_this2.imgList[_this2.index].stoped = false;
							_this2.imgList[_this2.index].opacity = 1;
							_this2.imgList[_this2.index].transZ = .1;
							_this2.index++;
							_this2.index %= _this2.imgList.length;
						}
					}
				}
			};
			...
			obserable.on('showListPage', function (data) {
